...
(function (config) {
    ...
    })(config.DirectionType || (config.DirectionType = {}));
    var DirectionType = config.DirectionType;
    //�Ա�����
    (function (GenderType) {
        GenderType[GenderType["unknow"] = -1] = "unknow";
        GenderType[GenderType["female"] = 0] = "female";
        GenderType[GenderType["male"] = 1] = "male";
    })(config.GenderType || (config.GenderType = {}));
    var GenderType = config.GenderType;
    //Ʒ������
    ...
    })(config.QualityType || (config.QualityType = {}));
    var QualityType = config.QualityType;
})(config || (config = {}));
